...
Meteor.startup(function() {
  if (Meteor.isServer) {
    ...
    var soul = new Genre();
    soul.name = "Soul";
    soul.avatar = "images/soul.jpg";
    soul.spotifyName = "soul";

    // The spotify web api console returns playlist for reggae
    // however when calling the function from this app
    // it doesn't return results.
    // TODO: Figure this out, it's weird.
    var reggae = new Genre();
    reggae.name = "Reggae";
    reggae.avatar = "images/reggae.jpg";
    reggae.spotifyName = "reggae";


    var genres = [trending, topHits, edm, rnb, rock, hiphop, indieAlt, party, country, pop, workout, soul];
